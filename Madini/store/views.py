...
from .models import ProductCategories , Feature, Review
...
# SHOW ITEMS -----test shop details

def test_shop(request,id):
    ...
    product_category = ProductCategories.objects.get(id=id)
    all_product_categories = ProductCategories.objects.all()
    products = Product.objects.filter(category=product_category)
    minerals = Product.objects.all()
    reviews = Review.objects.filter(product__category=product_category)
    ...
    return render(request, 'store/test_shop.html', context)

def test_item_detail(request,id):
    ...
    return render(request,'store/test_item_detail.html',context)
...
def test_cart(request):
    ...
    return render(request, 'store/test_cart.html', context)
...
def test_checkout(request):
    ...
    return render(request, 'store/test_checkout.html', context)

def test_testimonials(request):
    ...
    return render(request, 'store/test_testimonials.html', context)

def test_contactus(request):
    ...
    return render(request, 'store/test_contactus.html', context)
