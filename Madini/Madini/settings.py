"""
Django settings for Madini project.
...
SECRET_KEY = 'django-insecure-4#7^+zx-2)*e@ynb#+s5tq(q-rpn51fw8wum=jn$=hf1tgpld^'
...
WSGI_APPLICATION = 'Madini.wsgi.application'
